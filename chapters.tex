...
This chapter presents an overview of the most popular NLG models for building open-ended dialogue systems. Section \ref{usual_problems} presents approaches for resolving standard NLG problems, what were described in the section \ref{nlg_ds_problems}. Section \ref{emotional_problems} presents solutions for generating more emotional text.

\section{Approaches for dialogue systems problems}\label{usual_problems}

\section{Approaches for generating emotional conversation} \label{emotional_problems}

...
Each GPT-2 model represents one style. 4 such models are fine-tuned for humor, positive, negative and poetic styles. BART is fine-tuned on Persona-Chat dataset.
...
The probability of obtaining any such set of values is given by the hypergeometric distribution

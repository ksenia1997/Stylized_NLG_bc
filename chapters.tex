...
In the experiment using the Nucleus sampling, a lot more poetic phrases (``played with the sun``, ``Sometimes a great star was about to shine``, etc.) were generated than using Beam search strategy (``You are welcome, sir``). On the other hand, sequences generated by Nucleus sampling do not make sense in context at all; they are not very interconnected. Another experiments with Nucleus sampling are represented in the Tables \ref{tab:sst_wd_nucleus}, \ref{tab:jokes_nucleus}. The purpose of this thesis is to generate not only stylized sentences, but also to make them in the form of dialogue. In experiments with Beam search (other experiments are represented in the section \ref{sec_wd}), the sentences are more often related and relate to people’s descriptions.
...
\centering
 ...
 \hline
 \end{tabular}
 \caption{Experiment of a generated conversation by weighted decoding of combination of BART and GPT-2 models, trained on dataset with jokes. Decoding strategy is Beam search.}
...
\centering
 ...
 \hline
 \end{tabular}
 \caption{Experiment of a generated conversation by weighted decoding of combination of BART and GPT-2 models, trained on Shakespeare dataset. Decoding strategy is Beam search.}
...
\centering
 ...
 \hline
 \end{tabular}
 \caption{Experiment of a generated conversation by weighted decoding of combination of BART and GPT-2 models, trained on SST stylistic dataset. Decoding strategy is Beam search.}
\label{tab:sst_wd}
\end{table}

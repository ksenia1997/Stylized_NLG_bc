...
\begin{figure}[hbt]
  ...
  \caption{The architecture of the Transformer \cite{vaswani2017attention}.}
  \label{transformer}
\end{figure}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/persona_desc.pdf}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/partner_desc.pdf}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/uttr1_length.pdf}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/uttr2_length.pdf}

...
\section{Approaches for dialogue systems problems}\label{usual_problems} \label{related_work_ds_section}
...
This chapter describes implemented model for stylized text generation and the experiments performed. 
The designed architecture is represented in the Figure \ref{architecture_nlg}. All parts of the model were implemented in Python 3.7.3 with using PyTorch 1.4.0 framework.
...
Beam search, nucleus and temperature sampling were used to generate more varied answers. These decoding methods are described in detail in the section \ref{related_work_ds_section}.
...
Examples represented in the Tables \ref{tab:bart_conversation_gpt2}, \ref{tab:poetic_shakespear} shows the generated stylized dialogues with using stylistic datasets.
...
\centering
 ...
 \hline\hline
 \end{tabular}
 \caption{Experiment BART with GPT-2 trained on dataset with jokes.}
...
\subsubsection{Experiment of switching models}
